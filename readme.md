...
## Pregunta 3: Pregunta: ¿En qué situación preferirías usar switch en lugar de una cadena de if-else? ¿Hay algún caso en este ejercicio donde el switch no sería la mejor opción

## Respuesta :

cuando todas las decisiones dependen de una sola variable y estoy comparando ese valor.
Es totalmente adecuado; solo dejaría de serlo si las condiciones fueran más complejas o dependieran de más variables.
